...
app.post('/generate-resume', (req, res) => {
  const { firstName, middleName, lastName, title, designation, address, email, phoneNo, summary, skill, school, degree, city, startYear, endYear, eduDescription, jobTitle, company, location, startYear2, endYear2, jobDescription, projectName, projectLink, proDes } = req.body;
